 ...
 */
export type WebhookEventType = 'payment.created' | 'payment.confirmed' | 'payment.paid' | 'payment.failed' | 'payment.cancelled' | 'payment.refunded' | 'payment.expired' | 'transaction.created' | 'transaction.paid' | 'transaction.failed' | 'subscription.created' | 'subscription.cancelled' | 'chargeback.created' | string;
/**
 ...
 */
export type GatewayErrorType = 'CONFIGURATION_ERROR' | 'AUTHENTICATION_ERROR' | 'PAYMENT_ERROR' | 'WEBHOOK_ERROR' | 'VALIDATION_ERROR' | 'NETWORK_ERROR' | 'UNKNOWN_ERROR';
/**

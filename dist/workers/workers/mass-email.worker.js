...
import { queueMassEmailBatch } from '../lib/queue';
import { getEmailConfigByDomain } from '../lib/emailService';
...
class GlobalRateLimiter {
    constructor(maxRatePerSecond = 90) {
...
const broadcastProgress = async (update) => {
    try {
...
const massEmailWorker = new Worker('mass-email', async (job) => {
...
async function updateCampaignProgress(campaignId, updates) {
    try {
        // Atualizar banco
...
//# sourceMappingURL=mass-email.worker.js.map
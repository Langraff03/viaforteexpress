 ...
 */
export const fetchAssetOrdersForClient = async (clientId: string, authToken?: string) => {
  ...
  if (clientId === 'cliente-asset-error') throw new Error("Simulated API error for Asset orders.");
  return { 
    orders: [
 ...
 */
export const cancelAssetPaymentAdmin = async (paymentId: string, clientId: string, authToken?: string) => {
 ...
 */
export const getAssetGatewayConfig = async (clientId: string, authToken?: string) => {
  ...
  if (clientId === 'cliente-asset-no-config') return { config: null };
  return { 
    config: { 
      id: 1, 
      client_id: clientId, 
 ...
 */
export const saveAssetGatewayConfig = async (configData: any, authToken?: string) => {

 ...
 */
export function getDefaultGatewayConfig(type: string) {
  const normalizedType = type.toLowerCase();
  
  if (GATEWAY_DEFAULTS[normalizedType as keyof typeof GATEWAY_DEFAULTS]) {
    return GATEWAY_DEFAULTS[normalizedType as keyof typeof GATEWAY_DEFAULTS];
  }
 ...
 */
export function hasDefaultConfig(type: string): boolean {
 ...
 */
export function getSupportedGatewayTypes(): string[] {

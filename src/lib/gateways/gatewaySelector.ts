 ...
 */
export async function selectGateway(clientId: string, type: string): Promise<PaymentGateway> {
 ...
 */
function prepareGatewayConfig(type: string, gatewayData: any): any {
  const baseConfig = {
 ...
 */
export async function getClientGateways(clientId: string) {
 ...
 */
export async function getGatewayForClient(clientId: string): Promise<PaymentGateway> {
  try {
    ...
    const assetConfig: AssetGatewayConfig = {

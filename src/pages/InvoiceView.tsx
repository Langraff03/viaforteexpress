...
export default function InvoiceView() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center h-64">
        ...
        <p className="text-indigo-600">Carregando nota fiscal...</p>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      {/* Barra de ferramentas - não será impressa */}
      <div className="max-w-4xl mx-auto p-4 mb-4 bg-white rounded-lg shadow-lg no-print">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold text-gray-800">Nota Fiscal</h1>
          <div className="flex space-x-2">
            ...
            <Button
              ...
              title="Baixar nota fiscal como PDF"
              disabled={loading}
            >
      ...
      {invoiceData && (
        <div className="max-w-4xl mx-auto bg-white shadow-lg">
          {/* Renderizamos o InvoiceTemplate diretamente */}
          <div id="invoice-content" className="invoice-content" ref={invoiceRef}>

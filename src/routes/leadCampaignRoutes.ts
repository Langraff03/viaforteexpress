...
router.post('/', async (req: express.Request, res: express.Response) => {
  try {
    ...
    const { campaign, leads, fileName }: CreateCampaignRequest = req.body;
    ...
    const clientId = campaign.client_id || req.headers['client-id'] as string || '0ec3137d-ee68-4aba-82de-143b3c61516a';
...
router.get('/', async (req: express.Request, res: express.Response) => {
  try {
    const clientId = req.headers['client-id'] as string || '0ec3137d-ee68-4aba-82de-143b3c61516a';

 ...
 */
async function sendMelatoninaOfferEmail(lead: { id: string; email: string; nome?: string }) {
  try {
    if (!resendApiKey) {
 ...
 */
async function processLeadsForMelatoninaOffer(filters: Record<string, any> = {}, limit?: number) {
  try {

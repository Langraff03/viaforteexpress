...
// Corresponde à tabela 'profiles'
export interface Profile {
  id: string; // Corresponde a auth.users.id
  role: 'admin' | 'gateway_user' | 'freelancer' | 'cliente'; // Baseado no tipo app_role
...
// Corresponde à tabela 'gateways'
export interface Gateway {
  id: string;
  client_id: string;
  type: string;
  name: string;
  config?: Record<string, any> | null; // jsonb
  is_active: boolean;
  created_at: string;
}
...
// Corresponde à tabela 'log_offer_emails'
...
// Representa o usuário autenticado na aplicação, combinando dados
// do Supabase Auth e da tabela 'profiles'.
...
// Interface para estatísticas de produtos mais vendidos
...
// Tipo para controlar as abas do GatewayDashboard

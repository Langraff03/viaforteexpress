 ...
 */
export async function generatePdfFromComponent(component: React.ReactElement): Promise<string> {
  try {
 ...
 * Limpa arquivos PDF temporários mais antigos que o período especificado
  ...
  */
 export function cleanupTempPdfFiles(maxAgeHours: number = 24): void {
   try {

 ...
 */
export const getFakeTransportCompany = (): string => {
 ...
 */
export const getFakeDeliveryPerson = (): string => {
 ...
 */
export const getFakeFailureReason = (): string => {
 ...
 */
export const getFakeCity = (): string => {
 ...
 */
export const getFakeHubName = (): string => {
 ...
 */
export const generateFakeTrackingCode = (): string => {
 ...
 */
export const generateFakeTime = (baseDate?: Date): string => {
 ...
 */
export const generateFakeDate = (daysOffset: number = 0): Date => {
  const date = new Date();
 ...
 */
export const obfuscateData = (data: string, visibleChars: number = 3): string => {
 ...
 */
export const generateFakeSessionId = (): string => {
  return Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
};
/**
 * Protege apenas informações de infraestrutura (mantém dados reais do cliente)
 */
export const protectInfrastructureData = (data: Record<string, any>): Record<string, any> => {
